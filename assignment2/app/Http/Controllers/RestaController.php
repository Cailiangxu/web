...
class RestaController extends Controller
{
    ...
    public function index()
    {
        ...
        // dd($time);
        // return view('test')->with('time',$time);
        // dd(Auth::user()->id);

        // return view('resta_page')->with('restas',$restas);
    ...
    {
        return view('resta.create_form')->with('restas',Resta::all());
    }
    ...
    public function show($id)
    {
        ...
        return view('resta.menus')->with('menus',$menus); 
    ...
    {
        $menu = Menu::find($id);
        return view('resta.edit_form')->with('menu',$menu)->with('restas',Resta::all());
    }
